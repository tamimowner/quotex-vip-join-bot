TEXTS = {
    ...
    "need_deposit_hint": (
        ...
        "নিচের বাটন দিয়ে রেজিস্টার করুন।"
    ),
    ...
    "premium_info": (
        ...
        "4️⃣ বটে 8-digit Trader ID পাঠান\n"
        "5️⃣ ভেরিফাই হলে VIP ইনভাইট লিংক পাবেন\n\n"
    ...
    "status_not_verified": "❌ এখনো ভেরিফাই হয়নি। আগে আমাদের লিংক দিয়ে রেজিস্টার ও $20+ ডিপোজিট করুন।",
    "status_verified": (
    ...
    "create_account_guide": (
        ...
        "5. বটে 8-digit Trader ID পাঠান\n\n"
        "শুধু আমাদের Affiliate Link (lid=<code>1480996</code>) দিয়ে তৈরি নতুন অ্যাকাউন্ট গ্রহণযোগ্য।"
    ),
